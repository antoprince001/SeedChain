...
export default function ScaDash(){
    return(
  ...
  <nav className="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul className="navbar-nav">
      ...
      <li className="nav-item d-none d-sm-inline-block">
        <a href="index3.html" className="nav-link"> Seed Chain </a>
      </li>
      <li className="nav-item d-none d-sm-inline-block">
        <a href="Timeline.js" className="nav-link"> Timeline </a>
      </li>
    </ul>
    {/* SEARCH FORM */}
  ...
  <aside className="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" className="brand-link">
      ...
      <span className="brand-text font-weight-light"> Seed Chain </span>
    </a>
    {/* Sidebar */}
    <div className="sidebar">
      ...
      <div className="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div className="info">
          <a href="#" className="d-block"> SCA Dashboard </a>
        </div>
      </div>
      {/* Sidebar Menu */}
      <nav className="mt-2">
        ...
        <div className="row mb-2">
          ...
          <div className="col-sm-6">
            <ol className="breadcrumb float-sm-right">
              ...
              <li className="breadcrumb-item active"> Seed chain </li>
            </ol>
          </div>{/* /.col */}
        </div>{/* /.row */}
      </div>{/* /.container-fluid */}
        ...
        <div className="row">
          ...
          <div className="col-lg-3 col-6">
            ...
            <div className="small-box bg-success">
              <div className="inner">
                <h3> 20 <sup style={{fontSize: 20}}></sup></h3>
                <p> Verified Lot</p>
              </div>
              <div className="icon">
              ...
              <div className="card-footer bg-transparent">
                <div className="row">
                  ...
                  <div className="col-4 text-center">
                    ...
                    <div className="text-white"> Validated </div>
                  </div>
                  {/* ./col */}
                  <div className="col-4 text-center">
